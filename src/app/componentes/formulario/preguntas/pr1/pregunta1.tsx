        ...
        <article className="articlePr1">            
            ...
            <div className="imagenes">
                <button onClick={() => manejarCambio("11000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/solo2.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100}/>
                    <span> {t("op1")} </span>
                </button>

                <button onClick={() => manejarCambio("15000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/menosde15.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100}/>
                    <span> {t("op2")} </span>
                </button>

                <button onClick={() => manejarCambio("50000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/21a50.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100}/>
                    <span> {t("op3")} </span>
                </button>

                <button onClick={() => manejarCambio("75000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/51a100.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100} />
                    <span> {t("op4")} </span>
                </button>

                <button onClick={() => manejarCambio("85000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/100a150.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100} />
                    <span> {t("op5")} </span>
                </button>

                <button onClick={() => manejarCambio("100000", dispatch, "pr1", setIteracion)}>
                    <Image src="/Pregunta1/masde150.jpg" loading="eager" alt="Imagen visual de una boda" width={100} height={100} />
                    <span> {t("op6")} </span>
                </button>
            </div>
        </article>
